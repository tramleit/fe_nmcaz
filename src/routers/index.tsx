...
import LoginSuccess from "containers/PageLogin/LoginSuccess";
...
const Routes = () => {
  ...
  return (
    ...
    >
      ...
      <ScrollToTop />
      {window.location.href !== `${SITE_URL}login-success` ? <HeaderContainer /> : null}
      ...
      {window.location.href !== `${SITE_URL}login-success` ? <Footer /> : null}
